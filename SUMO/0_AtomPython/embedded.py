...
if runner.traci.isEmbedded():
    ...
    # sumo with this script as argument
    if options.nogui:
    ...
    # call sumo with the request to run this very same script again in the
    # internal interpreter
    # when this happens, the method traci.isEmbedded() in line 23 will
    # evaluate to true
    # and then the run method will be called
    retCode = subprocess.call([
                                sumoBinary, "-c", "data/toronto.sumocfg",
